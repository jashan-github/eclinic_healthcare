// components/e-clinic/admin/location/edit-location-dialog.tsx
...
const EditLocationDialog: React.FC<EditLocationDialogProps> = ({ isOpen, onClose, initialData }) => {
    ...
    useEffect(() => {
        if (initialData) {
            setFormData({
                clinicName: initialData.name,
                branchName: initialData.branch_type,
                address: initialData.address,
                countryId: initialData.country_id,
                stateId: initialData.state_id,
                cityId: initialData.city_id,
                phone: initialData.phone || '',
                email: initialData.email || '',
                isPrimary: initialData.is_primary,
            })
            setSelectedCountryId(initialData.country_id)
            setSelectedStateId(initialData.state_id)
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const payload: {
            ...
            branch_type: formData.branchName.trim() || 'Main Branch',
